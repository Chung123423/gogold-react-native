...
export default function BindPOS(){
    ...
    return (
        <Container>
            ...
            <View style={styles.content}>
                <ThemedText color={Colors.light_gold} type="defaultSemiBold">你已成功登入</ThemedText>
            </View>

            <View style={styles.card}>
                <ThemedText type="h2">黃金販賣機</ThemedText>
            </View>
            <ThemedText type='defaultSemiBold'>請繼續操作黃金販賣機</ThemedText>
